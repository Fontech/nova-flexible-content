...
use Fontech\NovaFlexibleContent\Value\Resolver;
use Fontech\NovaFlexibleContent\Value\ResolverInterface;
use Fontech\NovaFlexibleContent\Layouts\Preset;
use Fontech\NovaFlexibleContent\Layouts\Layout;
use Fontech\NovaFlexibleContent\Layouts\LayoutInterface;
use Fontech\NovaFlexibleContent\Layouts\Collection as LayoutsCollection;
...
class Flexible extends Field
{
     ...
     *
     * @var Fontech\NovaFlexibleContent\Layouts\Collection
     */
    protected $layouts;
     ...
     *
     * @var Fontech\NovaFlexibleContent\Value\ResolverInterface
     */
    protected $resolver;
     ...
     *
     * @param Fontech\NovaFlexibleContent\Layouts\LayoutInterface $layout
     * @return void
     */
     ...
     *
     * @param  string $key
     * @return null|\Fontech\NovaFlexibleContent\Http\FlexibleAttribute
     */
    ...
    protected function registerOriginModel($model)
    {
        if (is_a($model, \Laravel\Nova\Resource::class)) {
            $model = $model->model();
        } else if (is_a($model, \Fontech\NovaPage\Pages\Template::class)) {
